...
Meta‑learnings from building the ONE‑SHOT PDF→LLM converter; carry these into future work.
...
- Prefer typed, structured CLIs (e.g., Typer/Click) for testability.
...
- Keep `README.md` user-oriented and aligned to the ONE‑SHOT spec.
- Maintain a linear `HISTORY.md` for decision tracking.
